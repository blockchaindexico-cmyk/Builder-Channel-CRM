...
CREATE TABLE "roles" (
    ...
    "seeded_permissions" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "created_at" TIMESTAMPTZ(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "memberships_organization_id_reports_to_id_idx" ON "memberships"("organization_id", "reports_to_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "memberships_organization_id_employee_code_key" ON "memberships"("organization_id", "employee_code");
...
-- AddForeignKey
ALTER TABLE "memberships" ADD CONSTRAINT "memberships_organization_id_role_id_fkey" FOREIGN KEY ("organization_id", "role_id") REFERENCES "roles"("organization_id", "id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "memberships" ADD CONSTRAINT "memberships_organization_id_reports_to_id_fkey" FOREIGN KEY ("organization_id", "reports_to_id") REFERENCES "memberships"("organization_id", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
