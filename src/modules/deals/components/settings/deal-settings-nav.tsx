...
const TABS = [
  { href: "/settings/deals/outcomes", label: "Visit outcomes" },
  { href: "/settings/deals/reasons", label: "Loss reasons" },
  { href: "/settings/deals/stages", label: "Booking stages" },
  { href: "/settings/deals/options", label: "Options" },
];

export function DealSettingsNav() {
  const pathname = usePathname();
  return (
    <nav
      aria-label="Visit and booking settings"
